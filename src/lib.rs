...
#[derive(Debug)]
pub struct QuickNodeProcessor {
    verbose: bool,
    processed_count: usize,
}

impl QuickNodeProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting QuickNode processing");
    
    let mut processor = QuickNodeProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = QuickNodeProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = QuickNodeProcessor::new(false);
